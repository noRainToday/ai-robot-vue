...
const api:WindowApi = {
    ...
    onWindowMaximized: (callback: (maximized: boolean) => void) => ipcRenderer.on(IPC_EVENTS.IS_WINDOW_MAXIMIZED, (_, maximized) => callback(maximized)),
    isWindowMaximized: () => ipcRenderer.sendSync(IPC_EVENTS.IS_WINDOW_MAXIMIZED),
}
